...
"[project]/lib/axiosInstance.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getCsrfToken = async ()=>{
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${baseURL}/sanctum/csrf-cookie`, {
...
"[project]/hooks/use-auth-guard.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/axiosInstance.ts [app-ssr] (ecmascript)");
;
;
;
function useAuthGuard() {
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/logout');
        } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2d$guard$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/hooks/use-auth-guard.ts [app-ssr] (ecmascript)");
...
const Navbar = ()=>{
    ...
    const { isAuthenticated, user, logout, isLoading, isAdmin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2d$guard$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthGuard"])();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__65fa74._.js.map